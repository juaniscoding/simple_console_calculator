        ...
        byte mode = sc.nextByte();
            ...
            switch (mode) {
                ...
                case 0:
                    ...
                    System.out.println("press 2 for 2d (squares rectangles etc.)");
                    System.out.println("press 0 for sphere");
                    ...
                    if (areaMode == 3) {
                        ...
                        System.out.println("The area is " + length3 * breadth3 * height3);
                        ...
                        System.out.println("The area is " + l2 * b2);


                        //Area (circle)//
                    } else if (areaMode == 0) {
                        double sphereDiam, sphereRadius, sphereVolume;
                        System.out.println("Enter the diameter of a sphere:");
                        sphereDiam = sc.nextDouble();
